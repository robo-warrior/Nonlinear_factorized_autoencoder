...
def main_mlp(image_vector_size, learning_rate, iterations, decay_rate, num_samples, x_train):
  ...
  return z, num_samples*iterations, Loss, w1, b1, w2, b2
...
def main():
  ...
  plt.plot(x, Loss)
  plt.xlabel("60k samples, epochs=2")
  plt.ylabel("MSE loss")
  plt.title("MNIST Loss curve - sgd")
  plt.savefig("reg_sgd_loss_curve_10.jpg")
  plt.show()
  ...
  plt.savefig("reg_learned_data_representation_10.jpg")
  plt.show()
